...
print(source)
sect1=data.frame(x=1:4,y=c(15152,5093,2644,2009))
sect2=data.frame(x=4:7,y=c(2009,2051,1891,1751))
...
abline(a=fs1$coefficients[1],b=fs1$coefficients[2],col="red")
abline(a=fs2$coefficients[1],b=fs2$coefficients[2],col="green")
abline(a=fs3$coefficients[1],b=fs3$coefficients[2],col="blue")
dev.off()
